...
### 第一章 微调前置知识
- [01 提示工程实战指南](chapter1/01_提示工程实战指南.md) - 零训练成本解锁大模型潜力
- [02 从零构建AI智能体](chapter1/02_从零构建AI智能体.md) - ReAct范式与LangChain实战

### 第二章 理论基础
- [01 语言模型演进全解析](chapter2/01_语言模型演进全解析.md) - 从统计到GPT/BERT的核心突破
- [02 大模型预训练技术](chapter2/02_大模型预训练技术.md) - 从通识教育到千亿参数炼成

### 第三章 微调入门
- [01 大模型微调实战指南](chapter3/01_大模型微调实战指南.md) - 从理论到高效落地的核心路径
- [02 Hugging Face Transformers入门](chapter3/02_Hugging_Face_Transformers入门.md) - 大模型微调入门实战

### 第四章 PEFT参数高效微调
- [01 PEFT实战指南](chapter4/01_PEFT实战指南.md) - 用1%参数高效微调大模型
- [02 PEFT主流技术全解析](chapter4/02_PEFT主流技术全解析.md) - 四大核心类别与实战选型
- [03 Soft Prompt实战指南](chapter4/03_Soft_Prompt实战指南.md) - Prefix Tuning vs Prompt Tuning
- [04 P-Tuning演进全解析](chapter4/04_P-Tuning演进全解析.md) - 从V1到V2的核心技术
- [05 Adapter微调革命](chapter4/05_Adapter微调革命.md) - 用3.6%参数撬动大模型100%性能
- [06 LoRA低秩适配微调](chapter4/06_LoRA低秩适配微调.md) - 百万参数撬动十亿大模型
- [07 UniPELT实战指南](chapter4/07_UniPELT实战指南.md) - 统一高效微调大模型的终极框架

### 第五章 模型量化
- [01 大模型量化实战指南](chapter5/01_大模型量化实战指南.md) - 从16GB到4GB显存的高效压缩
- [02 GPTQ实战指南](chapter5/02_GPTQ实战指南.md) - 单GPU搞定千亿模型量化

### 第六章 模型部署
- [01 vLLM推理引擎深度拆解](chapter6/01_vLLM推理引擎深度拆解.md) - 核心加速机制与组件原理
- [02 Triton部署实战指南](chapter6/02_Triton部署实战指南.md) - 从设计思想到生产落地
